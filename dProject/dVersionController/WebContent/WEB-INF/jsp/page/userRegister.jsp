...
.button {
    line-height: 7px;
                                        ...
                                        <div class="group_sch">
                                            <div class="btn_wrap">
                                                ...
                                                <button class="button btn_blue btn_small" onclick="allClose()">All Close -</button>
                                                	<button class="button btn_small btn_blue" id="userJobCode" style="margin-left: 5px;">직급관리</button>
                                                	<button class="button btn_small btn_blue" id="userOffiCode">직책관리</button>
                                           ...
                                           <!--  <h4>User List</h4> -->
                                            <div class="pg_top">
                                                <div class="left">
                                                    ...
                                                    <button class="button btn_gray" onclick="getHRInformation()">인사정보 가져오기</button>
                                                </div>
                                                <!-- <div class="right">
                                ...
                                <p class="result_line"><span>RESULT</span></p>
                                            ...
                                            <div class="btn_wrap txt_right">
                                                <button class="button btn_gray" id="showDeletUser" onclick="showDeletUser()">삭제된 사용자 보기</button>
                                                <button class="button btn_blue" id="addGroup">겸직 설정</button>
                                                <!-- <button class="button btn_blue" id="chgGroup">Change group</button> -->
	...
	<div class="dialog pop_userJobCode"
			title="직급 관리" style="max-width: 800px;">
			<div class="pop_box">
				<h4>직급 목록</h4>
...
<div class="dialog pop_userJobCodeDelete" title="DELETE CONFIRM" style="max-width:1000px;">
	...
	<div class="dialog pop_userOffiCode"
			title="직책 관리" style="max-width: 800px;">
			<div class="pop_box">
				<h4>직책 목록</h4>
				<div class="tbl_wrap" id="userOffiCode_Grids"></div>
				<div class="txt_right mb5">
					<button class="button btn_small btn_gray" onclick="userOffiCode_save()">저장</button>
					<button class="button btn_small btn_gray"  onclick="userOffiCode_cancle()">취소</button>
					<button class="button btn_small btn_gray" onclick="userOffiCode_insert()">삽입</button>
					<button class="button btn_small btn_gray" onclick="userOffiCode_delete()">삭제</button>
					<button class="button btn_small btn_gray" id="userOffiCode_UpBtn">▲</button>
            		<button class="button btn_small btn_gray" id="userOffiCode_DownBtn">▼</button>
				</div>
			</div>
		</div>
		
<div class="dialog pop_userOffiCodeDelete" title="DELETE CONFIRM" style="max-width:1000px;">
    <div class="pop_box">
    	<div style="font-weight:bold;font-size:15px;margin:15px;">
		Would you like to delete it?
        </div>
            <div class="right" style="margin:15px; float: right;">
                <button class="button btn_blue" onclick="OffiCodeDelete()">Delete</button>
                <button class="button btn_purple" onclick="OffiCodeDeleteCancel()">Cancel</button>
            </div>
    </div>
</div>
        ...
        <div class="tbl_wrap">
            <table class="write project_Left_title">
                ...
                <tr>
                    ...
                    <!-- <td>
                        <input type="number" class="short userReg" id="reg_offi_tel_1">-<input type="number" class="short userReg" id="reg_offi_tel_2">-<input type="number" class="short userReg" id="reg_offi_tel_3">
                    </td> -->
                </tr>
                <tr>
                    <th class="required">Company Name<i>Required</i></th>
                    <td>
                        <input type="text" id="reg_company_nm" class="userReg"> * 회사이름 미입력시 현대중공업파워시스템으로 입력됩니다.
                    </td>
                </tr>
                <tr>
                    <th>Group</th>
        ...
        <div class="tbl_wrap">
            <table class="write">
                ...
                <!-- <tr>
                    <th class="required">Password<i>Required</i></th>
                    <td>
                        <input type="password" id="update_passwd" class="userReg" onchange="pwdCheck()">
                        <input type="hidden" id="pass_reg">
                        <p id="pwdCheckWarning" class="info red"></p>
                        <p class="red">
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" id="update_passwd_confirm" class="userReg" onchange="pwdConfirmCheck()">
                        <p id="pwdConfirmWarning" class="info red"></p>
                        <p class="red">
                            * 비밀번호는 10~20자의 영문 대, 소문자, 숫자, 특수문자 중 3개를 조합하여 사용해야 합니다. <br>
                            * 사용 가능 특수문자 : ` ~ ! @ # $ % ^ * ( ) - _ = +
                        </p>
                ...
                <tr>
                    ...
                    <!-- <td>
                        <input type="number" class="short userReg" id="update_offi_tel_1">-<input type="number" class="short userReg" id="update_offi_tel_2">-<input type="number" class="short userReg" id="update_offi_tel_3">
                    </td> -->
                </tr>
                <tr>
                    <th class="required">Company Name<i>Required</i></th>
...
<!-- 트리의 루트노드(현대중공업,고객사,협력업체 등) 삭제팝업 -->
<div class="dialog pop_rootOrgDelete" title="Delete Organization">
    <div class="pop_box">
    	<div style="font-weight:bold;font-size:15px;margin:15px;">
		하위에 부서나 유저가 속한 루트노드는 삭제할 수 없습니다.
        </div>
            <div class="right" style="margin:15px;">
                <button class="button btn_blue" onclick="deleteRootCancel()">Ok</button>
            </div>
    </div>
</div>
<!-- 조직그룹삭제팝업 -->
...
<!-- 사용자삭제팝업 -->
<div class="dialog pop_deleteUser" title="Delete User" style="max-width:1000px;">
    <div class="pop_box">
    	<div style="font-weight:bold;font-size:15px;margin:15px;">
                                            ...
                                            <div class="tbl_wrap">
                                                <table class="write">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="line">
                                                                <input type="radio" name="searchDeleteUser" value="delete_user_id" checked="checked">
                                                                <label for="">User ID</label>

                                                                <input type="radio" name="searchDeleteUser" value="delete_user_kor_nm" class="ml10">
                                                                <label for="">Kor. Name</label>
                                                            </div>
                                                            <div class="line">
                                                                <input type="text" id="usersSearchKeyword3">
                                                                <button class="button btn_search ml5" onclick="usersSearchDeleted()">Search</button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
