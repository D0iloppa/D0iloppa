<%@ page language="java" contentType="text/html; charset=UTF-8"
	    ...
	    <table class="write">
	    	<tbody>
	    		<tr>
	    			<th>기간</th>
	    			<td>
		    			<input type="date" id="olddayPrev"> ~ <input type="date" id="todayPrev">
		    			<input type="radio" name="date_chk_prev" id="search_allPrev" class="ml5" value="ALL" checked> <label class="" for="">전체</label>&nbsp;
						<input type="radio" name="date_chk_prev" id="search_weekPrev" class="ml5" value="Week"> <label class="" for="">한주</label>&nbsp;
						<input type="radio" name="date_chk_prev" id="search_monthPrev" class="ml5" value="Month"> <label class="" for="">한달</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <button class="button btn_blue" onclick="selectDayPrev()">Retrieve</button>
	    			</td>
	    		</tr>
	    	</tbody>
	    </table>
	...
	<div class="tbl_wrap scroll" id="collaboPrevList">
		
    </div>
    
    <div class="dialog pop_collaboPre" title="예고함 DRN 상세페이지" style="max-width:1200px;">
    	<div class="pop_box">
    		<div class="sec">
    			<div class="pg_top">
    				<div class="right">
    			...
    			<div class="tbl_wrap">
	    			<table class="write">
	                    ...
	                    <tr>
	                    	<th>DRN 제목</th>
		                    <td><input type="text" id="DRN_title_previ" style="width: 100%;" readonly></td>
		                    <th>DRN NO</th>
		                    <td><input type="text" id="DRN_no_previ" style="width: 100%;" readonly></td>
	                    </tr>
    			...
    			<div class="tbl_wrap">
	    			<table class="write">
	                	...
	                	<tr>
	                		<th>PROJECT NO</th>
		                    <td><input type="text" id="Project_no_previ" style="width: 100%;" readonly></td>
		                    <th>PROJECT NAME</th>
		                    <td><input type="text" id="Project_name_previ" style="width: 100%;" readonly></td>
		                    <th>DATE</th>
		                    <td><input type="text" id="Date_previ" style="width: 100%;" readonly></td>
	                	</tr>
	                	<tr>
	                		<th>DOC NO(REV NO)</th>
		                    <td colspan="3"><input type="text" id="Doc_no_previ" style="width: 100%;" readonly></td>
		                    <th>STATUS</th>
		                    <td><input type="text" id="Status_previ" style="width: 100%;" readonly></td>
	                	</tr>
	                	<tr>
	                		<th>DOC TITLE</th>
	                		<td colspan="5"><input type="text" id="Doc_title_previ" style="width: 100%;" readonly></td>
	                	</tr>
	                	<tr>
	                		<th>첨부문서</th>
	                		<td colspan="4">
