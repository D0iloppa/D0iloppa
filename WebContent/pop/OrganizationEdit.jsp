...
<script src="${pageContext.request.contextPath}/resource/js/OrganizationEdit.js"></script>
                                ...
                                <p class="result_line"><span>RESULT</span></p>
                                            ...
                                            <div class="btn_wrap txt_right">
                                                ...
                                                <button class="button btn_gray" onclick="deleteSelectUser()">Delete User</button>
	                                            <button class="button btn_blue" onclick="getUserList()">모든 사용자 보기</button>
                                            </div>
                                        </div>
                                    </div>
