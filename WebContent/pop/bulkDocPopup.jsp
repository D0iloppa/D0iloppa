...
<div class="DocPopup">
    <div class="pop_box">
        <section ng-app="angularResizable3" id="bulkDocNew_left">
            <div class="content">
                <div class="row" resizable r-flex="true">
                    <section id="pop_ed_left" resizable r-directions="['right']" r-flex="true" class="p_ed_left">
                        <h4>Document List</h4>
                        <div class="btn_wrap">
                            <button class="button btn_blue" onclick="popupRefreshButton('MCI')">Refresh</button>
                            <button class="button btn_blue" onclick="bulkNewButton()" id="bulkNewButton">New</button>
                        </div>
                        <p class="info mt10 mb5" id="popup_bmc_current_folder_path">
                        </p>
                        <div class="mb5">
                            <input type="checkbox" id="popup_bulk_rev_version" onchange="getPopupPrjDocumentIndexList('MCI')">
                            <label for="">All Version</label>
                        </div>
                        <div class="tbl_wrap icon_tbl" id="bulkDocNoTbl">
                        </div>
                    ...
                    <div id = "pdfDivBulk">
                        <div class="pg_top">
                             <div class="left">
                                    <button class="button btn_orange" id="bulk_revise" onclick="updateRevisionBulk()" disabled>
                                        Revise
                                    </button>
                                    <button class="button btn_green" onclick="getBulkAccessHisList()">
                                        Access History
                                    </button>
                                    <button class="button btn_orange" id="bulk_save" onclick="bulkDocSave()">
                                        Save
                                    </button>
                                    <button class="button btn_orange" id="bulk_delete" onclick="docDelete('MCI')">
                                        Delete
                                    </button>
                                </div>
                            <div class="right">
                                <button id="savePdf" class="btn_icon btn_blue" onclick="pageprint('MCI')"><i class="fas fa-print"></i><span>Print</span></button>
                               <!--  <button class="btn_icon btn_blue" onclick="procPopupClose()"><i class="fas fa-times"></i><span>Close</span></button> -->
                            </div>
                        </div>
                        <h4>BULK PROCESS <i id="bulk_locker" class="popup_locker"></i><i id="bulk_oldversion" class="popup_oldversion"></i></h4>
                        <div class="tbl_wrap" style="overflow-x:visible;">
                            <table class="write">
                                <tr>
                                    ...
                                    <td><input type="text" class="full popupinput" id="bulk_doc_no"></td>
                                    <th>Rev. No</th>
                                    <td>
                                    	<input type="hidden" id="bulk_rev_max">
                                        <div class="multi_sel_wrap" id="bulkRevNoSelectWrap">
                                        	<button class="multi_sel" id="bulkRevNoSelected">SELECT</button>
                                        	<input type="hidden" id="bulkSelectedRevNoSetCodeId">
                                        	<input type="hidden" id="bulk_origin_rev_code_id">
                                        	<div class="multi_box">
                                            	<table id="bulkRevNoMultiBox">
                                            	</table>
                                       		</div>
                                    	</div>
                                    </td>
                                </tr>
                                <tr id="bulkFileAttachTr">
                                    <th>File Attach</th>
                                    <td colspan="3">
                                        <!--  <button class="button btn_blue">Attach</button> -->
										<form id="updateRevisionBulkForm" style="display:flex;" name="updateRevisionBulkForm"  enctype="multipart/form-data" method="post" onsubmit="return false;">
					                    	<span id="rfile_download" class="property_attach" onclick="propertydownload()"></span>
					                        <span class="filebox">
					                        	<input type="text" id="bulk_uploadFileDate" disabled style="width: 190px;">
					                     	   	<input type="file" name="updateRevision_File" id="bulk_attach_filename" class="upload-hidden bulkDocumentFileAttach">
						                        <label for="bulk_attach_filename" class="button btn_blue" id="bulk_popup_attach">Attach</label>
					                    	</span>
					                    <!-- <span class="filebox">
					                        <input class="upload-name" value="파일선택" id="bulk_attachfilename" disabled="disabled">
					                        <label for="bulk_attach_filename" class="button btn_blue" id="bulk_popup_attach">Attach</label>
					                        <input type="file" name="updateRevision_File" id="bulk_attach_filename" class="upload-hidden bulkDocumentFileAttach">
					                    </span>
					                    <input type="text" id="bulk_uploadFileInfo" disabled><input type="text" class="ml5" id="bulk_uploadFileDate" disabled>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input type="text" class="full popupinput" id="bulk_title"></td>
                                </tr>
                                <tr>
                                    <th>Creation</th>
                                    <td><input type="text" class="full popupinput" id="bulk_creation" disabled></td>
                                    <th>Modification</th>
                                    <td><input type="text" class="full popupinput" id="bulk_modification" disabled></td>
                                </tr>
                                <tr>
                                    <th>Discipline</th>
                                    <td><input type="hidden" id="bulk_discipline_code_id"><input type="text" class="full popupinput" id="bulk_discipline" disabled></td>
                                    <th class="required">
                                        Designer <i>required</i>
                                    </th>
                                	<td>
										<select id="bulk_designer_id" class="full" onChange="desginerChange()"></select>
					                </td> 
								</tr>
                                <tr>
                                    <th>WBS Code</th>
                                    <td>
                                        <div class="multi_sel_wrap" id="bulkWbsCodeSelectWrap">
                                        	<button class="multi_sel" id="bulkWbsCodeSelected">SELECT</button>
                                        	<input type="hidden" id="bulkSelectedWbsCodeId">
                                        	<div class="multi_box">
                                            	<table id="bulkWbsCodeMultiBox">
                                            	</table>
                                       		</div>
                                    	</div>  
                                    </td>
                                    ...
                                    <td><input type="hidden" id="bulk_pre_designer_id"><input type="text" class="full popupinput" id="bulk_pre_designer" disabled></td>
                                </tr>
                                <tr>
                                    <th>WBS Detail</th>
                                    <td colspan="3">
                                        <input type="text" style="width:20%;" id="bulk_wbs_detail_1" disabled>
                                        <input type="text" style="width:75%;" id="bulk_wbs_detail_2" disabled>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Remark</th>
                                    <td colspan="3">
                                    	<textarea class="full" rows="30" id="bulk_remark"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                	<th>POR NO</th>
                                	<td>
                                        ...
                                        <div class="multi_sel_wrap" id="bulkPorNoSelectWrap">
                                        	<button class="multi_sel" id="bulkPorNoSelected">SELECT</button>
                                        	<input type="hidden" id="bulk_por_no">
                                        	<div class="multi_box">
                                            	<table id="bulkPorNoMultiBox">
                                            	</table>
                                       		</div>
                                    	</div> 
                                	</td>
                                	<th>PO NO</th>
                                	<td><input type="text" class="full" id="bulk_po_no"></td>
                                </tr>
                                <tr>
                                	<th>POR ISSUE DATE</th>
                                	<td>
                                		<input type="text" class="date" id="bulk_por_issue_date">
                                	</td>
                                	<th>PO ISSUE DATE</th>
                                	<td><input type="text" class="date" id="bulk_po_issue_date"></td>
                                </tr>
                                <tr>
                                	<th>VENDOR</th>
                                	<td>
                                		<input type="text" class="full" id="bulk_vendor_nm">
                                	</td>
                                	<th>VENDOR DOC. NO</th>
                                	<td><input type="text" class="full" id="bulk_vendor_doc_no"></td>
                                </tr>
                            </table>
                        </div>
                        <h4>Document Progress</h4>
                        <div class="tbl_wrap" id="bulkDocProgress">
                        </div>
                </div>
                    </section>
                </div>
...
var bulk_selected_doc_id = '';
var bulk_selected_rev_id = '';
...
var bulk_new_or_update = opener.document.getElementById('bulk_new_or_update').value;
...
$(function(){
	...
	if(auth.w==='Y'){
		$('#bulk_revise').css('display','inline-block');
		$('#bulk_save').css('display','inline-block');
		$('#bulkNewButton').css('display','inline-block');
	}else{
		$('#bulk_revise').css('display','none');
		$('#bulk_save').css('display','none');
		$('#bulkNewButton').css('display','none');
	}
	if(auth.d==='Y'){
		$('#bulk_delete').css('display','inline-block');
	}else{
		$('#bulk_delete').css('display','none');
	}
	
	//Bulk 파일첨부
    var fileTarget = $('.filebox .bulkDocumentFileAttach');
    ...
    fileTarget.on('change', function () {
        ...
        var today = new Date();
        $('#bulk_uploadFileDate').val(formatBytes(size,2)+', '+today.toLocaleString());
        if($('#bulk_locker').html()!=='' && $('#bulk_rev_max').val()===bulk_selected_rev_id && $('#bulkSelectedRevNoSetCodeId').val()!=='' && $('#bulk_origin_rev_code_id').val()!==$('#bulkSelectedRevNoSetCodeId').val()){
        	$('#bulk_revise').attr('disabled',false);
        }
    });
    
	var process = opener.document.getElementById('process').value;
	if(process==='new'){
    	$('#popup_bmc_current_folder_path').html(current_folder_path);
    	/* $('#bulkRevNoSelected').css('pointer-events', 'none');
    	$('#bulkRevNoSelected').css('background', 'none');
    	$('#bulkRevNoSelected').css('background-color', '#FAFAFA');
    	$('#bulkRevNoSelected').css('color', '#FAFAFA'); */
    	getRevNoMultiBox('MCI');
    	getWbsCodeMultiBox('MCI');
        getPopupPrjDocumentIndexList('MCI');
        getPrjStep('','','MCI','new');
        setBulkNull();
		...
		bulk_selected_doc_id = doc_id;
		bulk_selected_rev_id = rev_id;
		let trans_ref_doc_id = opener.document.getElementById('trans_ref_doc_id').value;
    	$('#popup_bmc_current_folder_path').html(current_folder_path);
    	/* $('#bulkRevNoSelected').css('pointer-events', 'auto');
    	$('#bulkRevNoSelected').css('background', 'url(../resource/images/select.png) no-repeat right center #fff');
    	$('#bulkRevNoSelected').css('background-color', '#fff');
    	$('#bulkRevNoSelected').css('color', '#000'); */
    	getRevNoMultiBox('MCI',doc_id);
    	getWbsCodeMultiBox('MCI');
        getPopupPrjDocumentIndexList('MCI','D');
        if(DCCorTRA==='DCC'){
	        getPrjStep(doc_id,rev_id,'MCI');
	    	getBulkDocumentInfo(doc_id,rev_id);
        }else if(DCCorTRA==='TRA'){
	        getPrjStep(trans_ref_doc_id,rev_id,'MCI');
	        getBulkDocumentInfo(trans_ref_doc_id,rev_id);
        }
	}
});
function getPopupPrjDocumentIndexList(type,refresh){
	...
	if(type==='DCI'){
		...
		select_rev_version = $('#popup_bulk_rev_version').is(':checked')===true?'all':'current';
	}else if(type==='SDCI'){
...
function setPopupPrjDocumentIndexList(doc_ctrl_li,type){
	...
	if(type==='DCI'){
		...
		thisTable = bulkDocumentListTable;
		tableid = '#bulkDocNoTbl';
	}else if(type==='SDCI'){
	...
	thisTable.on("rowSelected", function(row){
		...
		if(type==='DCI'){
			...
			if(DCCorTRA==='DCC'){
				...
				bulk_selected_doc_id = trans_ref_doc_id;
			}
			bulk_selected_rev_id = rev_id;
	    	getBulkDocumentInfo(bulk_selected_doc_id,bulk_selected_rev_id);
	    	getRevNoMultiBox('MCI',doc_id);
		}else if(type==='SDCI'){
			if(DCCorTRA==='DCC'){
...
function getBulkDocumentInfo(doc_id,rev_id){
	//$('#bulkFileAttachTr').css('display','table-row');
	bulk_new_or_update = 'update';
	$.ajax({
	    url: '../getBulkDocumentInfo.do',
	    type: 'POST',
	    data:{
	    	prj_id:selectPrjId,
	    ...
	    success: function onData (data) {
	    	...
	    	if(data[0].lock_yn==='Y'){
	    		$('#bulk_locker').html('Locker '+data[0].mod_nm+' ('+data[0].mod_id+')');
	    		$('#bulk_revise').attr('disabled',true);
	    		$('#bulk_save').attr('disabled',true);
	    	}else{
	    		$('#bulk_locker').html('');
	    		$('#bulk_save').attr('disabled',false);
	    	}
	    	$('#bulk_rev_max').val(data[0].rev_max);
	    	if(data[0].rev_max!==rev_id && data[0].rev_max!=='001'){
	    		$('#bulk_oldversion').html('Old Version');
	    	}else{
	    		$('#bulk_oldversion').html('');
	    	}
	    	$('#bulk_doc_no').val(data[0].doc_no);
	    	if(data[0].rev_code_id!==null && data[0].rev_code_id!==undefined && data[0].rev_code_id!==''){
		    	$('#bulk_doc_no').attr("disabled", true);
		    	$('#bulkRevNoSelected').html(data[0].rev_no);
		    	$('#bulk_origin_rev_code_id').val(data[0].rev_code_id);
		    	$('#bulkSelectedRevNoSetCodeId').val(data[0].rev_code_id);
	    	}else{
		    	$('#bulk_doc_no').attr("disabled", false);
		    	$('#bulkRevNoSelected').html('SELECT');
		    	$('#bulk_origin_rev_code_id').val('');
		    	$('#bulkSelectedRevNoSetCodeId').val('');
	    	}
	    	if(data[0].rfile_nm!==null && data[0].rfile_nm!==undefined && data[0].rfile_nm!==''){
		    	...
		    	$('#bulk_uploadFileDate').val(formatBytes(data[0].file_size,2)+attach_file_date);
		    	$('#rfile_download').html(data[0].rfile_nm);
		    	$('#rfile_download').addClass('property_download');
		    	$('#rfile_download').removeClass('property_attach');
	    	}else{
		    	$('#bulk_uploadFileDate').val('');
		    	$('#rfile_download').html('');
		    	$('#rfile_download').addClass('property_attach');
		    	$('#rfile_download').removeClass('property_download');
	    	}
	    	$('#bulk_title').val(data[0].title);
	    	$('#bulk_creation').val(data[0].reg_nm+'('+data[0].reg_kor_nm+'): '+getDateFormat(data[0].reg_date));
	    	$('#bulk_modification').val(data[0].mod_date===null?'':data[0].mod_nm+'('+data[0].mod_kor_nm+'): '+getDateFormat(data[0].mod_date));
	    	$('#bulk_discipline').val(data[0].discip_display);
		    $('#bulk_discipline_code_id').val(data[0].discip_code_id);
			let bulk_designer_id = $('#bulk_designer_id').eq(0).data('selectize');
			bulk_designer_id.setValue(data[0].designer_id,false);
	    	$('#bulk_pre_designer').val(data[0].pre_designer_nm+'('+data[0].prfe_designer_id+')');
	    	$('#bulk_pre_designer_id').val(data[0].prfe_designer_id);
	    	if(data[0].wbs_code_id!==null && data[0].wbs_code_id!==undefined && data[0].wbs_code_id!==''){
		    	$('#bulkWbsCodeSelected').html(data[0].wbs_code);
		    	$('#bulkSelectedWbsCodeId').val(data[0].wbs_code_id);
	    	}else{
		    	$('#bulkWbsCodeSelected').html('SELECT');
	    	}
	    	$('#bulk_wbs_detail_1').val(data[0].wgtval);
	    	$('#bulk_wbs_detail_2').val(data[0].wbs_desc);
	    	$('#bulk_remark').val(data[0].remark);
	    	$('#bulkPorNoSelected').html(data[0].por_no);
	    	$('#bulk_por_no').val(data[0].por_no);
	    	...
	    	$('#bulk_por_issue_date').val(por_issue_date);
	    	$('#bulk_po_no').val(data[0].po_no);
	    	$('#bulk_po_issue_date').val(po_issue_date);
	    	$('#bulk_vendor_nm').val(data[0].vendor_nm);
	    	$('#bulk_vendor_doc_no').val(data[0].vendor_doc_no);
	    },
	    error: function onError (error) {
	        console.error(error);
	    }
...
function docDeleteConfirm(){
	...
	let doc_no = $('#bulk_doc_no').val();
	let doc_title = $('#bulk_title').val();
...
function setBulkNull(){
	$('#rfile_download').html('');
	//$('#bulkFileAttachTr').css('display','none');
	DC.sfile_nm = '';
    DC.rfile_nm = '';
    DC.file_type = '';
    DC.file_size = 0;
	$('#bulk_doc_no').attr("disabled", false);
    $('#bulk_attach_filename').val('');
	$('#bulk_locker').html('');
	$('#bulk_oldversion').html('');
	$('#bulk_doc_no').val('');
	$('#bulkRevNoSelected').html('SELECT');
	$('#bulk_revise').attr('disabled',true);
	$('#bulk_save').attr('disabled',false);
	$('#bulkSelectedSetCodeId').val('');
	$('#bulk_title').val('');
	$('#bulk_creation').val(session_user_eng_nm+'('+session_user_kor_nm+'): '+ $('#currentTime').val());
	$('#bulk_modification').val(session_user_eng_nm+'('+session_user_kor_nm+'): '+ $('#currentTime').val());
	if(current_folder_discipline_code_id===null || current_folder_discipline_code_id===undefined || current_folder_discipline_code_id===''){
		$('#bulk_discipline_code_id').val($('#docSelTree_discipline_code_id').val());
		$('#bulk_discipline').val($('#docSelTree_discipline_display').val());
	}else{
		$('#bulk_discipline_code_id').val(current_folder_discipline_code_id);
		$('#bulk_discipline').val(current_folder_discipline_display);
	}
	let bulk_designer_id = $('#bulk_designer_id').eq(0).data('selectize');
	bulk_designer_id.setValue('',false);
	$('#bulk_pre_designer_id').val('');
	$('#bulk_pre_designer').val('');
	$('#bulkSelectedWbsCodeId').val('');
	$('#bulkWbsCodeSelected').html('SELECT');
	$('#bulk_wbs_detail_1').val('');
	$('#bulk_wbs_detail_2').val('');
	$('#bulk_remark').val('');
	$('#bulk_por_no').val('');
	$('#bulkPorNoSelected').html('SELECT');
	$('#bulk_po_no').val('');
	$('#bulk_por_issue_date').val('');
	$('#bulk_po_issue_date').val('');
	$('#bulk_vendor_nm').val('');
	$('#bulk_vendor_doc_no').val('');
	$('#bulk_uploadFileDate').val('');
}
	...
	$.ajax({
	    ...
	    success: function onData (data) {
	    	...
	    	if(type==='DCI'){
		    	...
		    	$('#bulkRevNoMultiBox').html(html);
	        	$('.usedRevNo').click(function(){
	        		alert('이전에 사용했던 리비전은 다시 선택할 수 없습니다.');
	        	});

		    	$('.selectRevNo').click(function(){
		    		let origin_rev_no = $('#bulkRevNoSelected').html();
		    		$('#bulkRevNoSelectWrap').removeClass('on');
		    		$('#bulkRevNoSelected').html($(this).children().html());
		    		$('#bulkSelectedRevNoSetCodeId').val($(this).children().attr('id'));
		    		if($('#bulk_origin_rev_code_id').val()!==$('#bulkSelectedRevNoSetCodeId').val()){
		    			let origin_rev_code_id = parseInt($('#bulk_origin_rev_code_id').val());
		    			let select_rev_code_id = parseInt($('#bulkSelectedRevNoSetCodeId').val());
		    			    if($('#bulk_locker').html()!==''){
				    	        $('#bulk_revise').attr('disabled',true);
			    	        	$('#bulk_save').attr('disabled',true);
			    	        }else{
	...
	$.ajax({
	    ...
	    success: function onData (data) {
    		...
    		if(type==='DCI'){
		    	...
		    	$('#bulkWbsCodeMultiBox').html(html);
		    	$('.selectWbsCode').click(function(){
		    		$('#bulkWbsCodeSelectWrap').removeClass('on');
		    		$('#bulkWbsCodeSelected').html($(this).children().html());
		    		$('#bulkSelectedWbsCodeId').val($(this).children().attr('id'));
		    		$('#bulk_wbs_detail_1').val($(this).children().next().next().html());
		    		$('#bulk_wbs_detail_2').val($(this).children().next().html());
		    	});
	    	}else if(type==='SDCI'){
...
function getPORListMultiBox(){
	$.ajax({
	    ...
	    success: function onData (data) {
	    	...
	    	$('#bulkPorNoMultiBox').html(html);
	    	$('.selectPorNo').click(function(){
	    		$('#bulkPorNoSelectWrap').removeClass('on');
	    		$('#bulkPorNoSelected').html($(this).children().html());
	    		$('#bulk_por_no').val($(this).children().attr('id'));
	    		$('#bulk_po_no').val($(this).children().next().html());
	    		$('#bulk_por_issue_date').val($(this).children().next().next().html());
	    		$('#bulk_po_issue_date').val($(this).children().next().next().next().html());
	    		$('#bulk_vendor_nm').val($(this).children().next().next().next().next().html());
	    	});
	    },
	    error: function onError (error) {
	        console.error(error);
...
function desginerChange(){
	let bulk_designer_id = $('#bulk_designer_id').text();
	if(bulk_new_or_update==='new'){
		$('#bulk_pre_designer_id').val($('#bulk_designer_id').val());
		$('#bulk_pre_designer').val(bulk_designer_id);
	}
}
function getPrjMemeberListForDesigner(){
	$.ajax({
	    ...
	    success: function onData (data) {
	    	...
	    	$('#bulk_designer_id').html(html);
	    	
	    	$("#bulk_designer_id").selectize({
	    		persist: false,
	    		openOnFocus:false,
				create: false,
				maxItems:1,
...
function setPrjStep(data,type){
	...
	if(type==='DCI'){
		...
		StepTable = DCBulkStepTable;
		tableId = '#bulkDocProgress';
	}else if(type==='SDCI'){
...
function bulkDocSave(){
	let doc_id = bulk_new_or_update==='new'?'':bulk_selected_doc_id;
	let rev_id = bulk_new_or_update==='new'?'':bulk_selected_rev_id;
	let doc_no = $('#bulk_doc_no').val();
	let origin_rev_code_id = $('#bulk_origin_rev_code_id').val();
	let rev_code_id = $('#bulkSelectedRevNoSetCodeId').val();
	let folder_id = parseInt(current_folder_id);
	let title = $('#bulk_title').val();
	let discip_code_id = $('#bulk_discipline_code_id').val();
	let designer_id = $('#bulk_designer_id').val();
	let pre_designer_id = $('#bulk_pre_designer_id').val();
	let wbs_code_id = $('#bulkSelectedWbsCodeId').val();
	let remark = $('#bulk_remark').val();
	let por_no = $('#bulk_por_no').val();
	let po_no = $('#bulk_po_no').val();
	let por_issue_date = $('#bulk_por_issue_date').val().replaceAll('-','');
	let po_issue_date = $('#bulk_po_issue_date').val().replaceAll('-','');
	let vendor_nm = $('#bulk_vendor_nm').val();
	let vendor_doc_no = $('#bulk_vendor_doc_no').val();
    let file_value = $('#bulk_attach_filename').val();
	...
	var params = {
			prj_id:selectPrjId,
			popup_new_or_update:bulk_new_or_update,
	...
	if(doc_no==='' || doc_no===null || doc_no===undefined){
	    ...
	    formData.set('set_code_type','BULK STEP');
				...
				success: function(data) {
					if(data[0]==='확장자 오류'){
						...
						if(data[0]==='파일 수정 불가'){
							...
							if(data[0]>0){
								getPopupPrjDocumentIndexList('MCI');
								getBulkDocumentInfo(data[1],data[2]);
								bulk_selected_doc_id = data[1];
								bulk_selected_rev_id = data[2];
				...
				success: function(data) {
					if(data[0]==='확장자 오류'){
						...
						if(data[0]>0){
							if(bulk_new_or_update==='new'){
								doc_id=data[2];
								bulk_selected_doc_id = data[2];
							}
							getPopupPrjDocumentIndexList('MCI');
							$('#bulk_save').attr('disabled',false);
							$('#bulk_revise').attr('disabled',true);
							getBulkDocumentInfo(doc_id,data[1]);
							getRevNoMultiBox('MCI',doc_id);
							alert('CheckIn Completed');
							bulk_selected_rev_id = data[1];
...
function pageprint(docType){
	if(docType === 'DCI'){
	    ...
	    html2canvas($('#pdfDivBulk')[0]).then(function(canvas) { //저장 영역 div id
...
function getBulkAccessHisList() {
	$(".pop_accHis").dialog("open");
	
	let doc_id = bulk_new_or_update==='new'?'':bulk_selected_doc_id;
	let rev_id = bulk_new_or_update==='new'?'':bulk_selected_rev_id;
	let doc_no = $('#bulk_doc_no').val();
	let rev_code_id = $('#bulkRevNoSelected').html();
...
function propertydownload(){
	$.ajax({
	    ...
	    data:{
	    	prj_id:selectPrjId,
	    	folder_id:current_folder_id,
	    	doc_id:bulk_selected_doc_id,
	    	rev_id:bulk_selected_rev_id,
	    	inout:''
	    },
	    success: function onData (data) {
			let multiDownTbl = [];
