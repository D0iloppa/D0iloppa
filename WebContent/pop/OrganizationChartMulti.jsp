...
<script src="${pageContext.request.contextPath}/resource/js/OrganizationChartMulti.js"></script>
                                ...
                                <p class="result_line"><span>RESULT</span></p>
                                            ...
                                            <div class="btn_wrap txt_right">
	                                            <button class="button btn_blue" onclick="setSelectUser()">해당 유저 설정하기</button>
	                                        </div>
                                            	<div class="gray_small_box" id="projectCreation_small_box">
										            <input type="hidden" id="selectIdList">
                                            		<input type="hidden" id="selectNameList">
                                            		<ul class="user_name" id="selectIdUserNameList">
										         	</ul>
										        </div>
