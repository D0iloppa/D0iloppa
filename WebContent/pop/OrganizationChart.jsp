...
<script src="${pageContext.request.contextPath}/resource/js/OrganizationChart.js"></script>
                                ...
                                <p class="result_line"><span>RESULT</span></p>
                                            ...
                                            <div class="btn_wrap txt_right">
	                                            <button class="button btn_blue" onclick="setSelectUser()">해당 유저 선택하기</button>
                                            </div>
