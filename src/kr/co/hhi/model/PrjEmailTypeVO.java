...
public class PrjEmailTypeVO {
	String prj_id;
	String email_type_id;
	String email_type;
	String email_feature;
	String email_desc;
	String reg_id;
	String reg_date;
	String mod_id;
	...
	public String getTr_send_date() {
		return tr_send_date;
	}
	public void setTr_send_date(String tr_send_date) {
		this.tr_send_date = tr_send_date;
	}
	...
	public String getEmail_feature() {
		return email_feature;
	}
	public void setEmail_feature(String email_feature) {
		this.email_feature = email_feature;
	}
	...
	public String getEmailTypeNewUpdate() {
		return emailTypeNewUpdate;
	}
	public void setEmailTypeNewUpdate(String emailTypeNewUpdate) {
		this.emailTypeNewUpdate = emailTypeNewUpdate;
	}
