...
public class RequestWrapper extends HttpServletRequestWrapper{
	...
	private String cleanXSS(String value) {
		...
		value = value.replaceAll("<iframe"                                   , "no_<iframe");
		value = value.replaceAll("<object"                                   , "no_<object");
		value = value.replaceAll("<embed"                                    , "no_<embed");
		value = value.replaceAll("document.cookie"                           , "no_document.cookie");
