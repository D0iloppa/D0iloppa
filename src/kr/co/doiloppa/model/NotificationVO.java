...
public class NotificationVO {
	...
	public String getReply_req_date() {
		return reply_req_date;
	}
	public void setReply_req_date(String reply_req_date) {
		this.reply_req_date = reply_req_date;
	}
